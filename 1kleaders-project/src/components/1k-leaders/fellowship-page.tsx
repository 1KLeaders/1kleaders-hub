    ...
    <div className="min-h-screen text-white flex items-center justify-center p-6" style={{ backgroundColor: '#111111', colorScheme: 'dark' }}>
      <div className="w-full max-w-2xl">
        ...
        <div className="grid grid-cols-4 border border-white/10 rounded-xl overflow-hidden mb-10">
          {[['6 mo','Fellowship'],['~25 min','To complete'],['Aug 31','Deadline'],['EN','Language']].map(([val, label], i) => (
    ...
    <div className="min-h-screen bg-[#111] text-white flex items-center justify-center p-6">
      <div className="w-full max-w-lg text-center">
        ...
        <p className="text-white/70 leading-relaxed mb-10">
          Thanks for applying to the AI Venture Builder Fellowship. We review every application by hand — you'll hear from us by email after the August 31 deadline with next steps.
        </p>
