      ...
      <nav className="fixed top-0 left-0 w-full z-50 transition-all duration-500" id="main-nav">
        <div className="px-[5vw] py-[7vh] flex items-center justify-between transition-all duration-500" id="nav-inner">
          <button className="h-[4.2rem] bg-transparent border-none cursor-pointer" onClick={() => navigate('landing')}>
            <img src="/logo-light-mid.png" alt="1KLeaders" className="h-full transition-all duration-300 object-contain" />
          </button>
          <div className="hidden md:flex items-center gap-10">
            <a href="#about" className="text-white font-medium no-underline relative hover:opacity-80 transition-opacity" style={{ fontFamily: 'var(--font-rethink-sans), Rethink Sans, sans-serif' }}>What We Do</a>
            <a href="#offer" className="text-white font-medium no-underline relative hover:opacity-80 transition-opacity" style={{ fontFamily: 'var(--font-rethink-sans), Rethink Sans, sans-serif' }}>What We Offer</a>
            <a href="#cta" className="text-white font-medium no-underline relative hover:opacity-80 transition-opacity" style={{ fontFamily: 'var(--font-rethink-sans), Rethink Sans, sans-serif' }}>Join Us</a>
            <button onClick={() => navigate('login')} className="text-white font-medium bg-transparent border-none cursor-pointer hover:opacity-80 transition-opacity" style={{ fontFamily: 'var(--font-rethink-sans), Rethink Sans, sans-serif' }}>
              Sign In
            </button>
