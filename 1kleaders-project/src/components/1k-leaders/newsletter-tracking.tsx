...
const readerDetails = [
  { name: 'Ahmed Al-Rashid', role: 'partner' as RoleBadge, opened: true, clicked: true, interacted: true, lastActivity: '2 hours ago' },
  ...
  { name: 'Khalid Nasser', role: 'partner' as RoleBadge, opened: false, clicked: false, interacted: false, lastActivity: '-' },
