              ...
              <>
                ...
                <div className="grid sm:grid-cols-2 gap-4">
                  ...
                  <div><Label className="text-[#222]">Country</Label>
                    <Select><SelectTrigger className="border-[#f0f0f0]"><SelectValue placeholder="Select country" /></SelectTrigger>
                      <SelectContent>
            ...
            {step === 3 && (
              <>
                ...
                <div><Label className="text-[#222]">How did you hear about us?</Label>
                  <Select><SelectTrigger className="border-[#f0f0f0]"><SelectValue placeholder="Select source" /></SelectTrigger>
